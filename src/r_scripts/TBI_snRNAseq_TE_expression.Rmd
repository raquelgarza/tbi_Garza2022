...
tbi <- readRDS("3_combinedUMAP_perCluster/tbi_per_condition_tbi.rds")
control <- readRDS("3_combinedUMAP_perCluster/tbi_per_condition_control.rds")
```
...
control_TE_norm <- fread("3_combinedUMAP_perCluster/clusterPipeline_per_condition/TE_counts_normalized/multiple/control_TE_norm_cluster_size_matrix.csv", data.table = F)
tbi_TE_norm <- fread("3_combinedUMAP_perCluster/clusterPipeline_per_condition/TE_counts_normalized/multiple/tbi_TE_norm_cluster_size_matrix.csv", data.table = F)
...
ggplot(ltr5hs, aes(x=UMAP_1, y=UMAP_2, colour=(LTR5_HS))) + geom_point(size=0.5) + facet_wrap(.~condition) + theme_classic() + scale_color_gradient(low = "lightgray", high = "red") + labs(colour="Cluster expression\n(norm by num cells)") + theme(text=element_text(size=15)) + ggtitle("LTR5-HS")
...
ggplot(ltr5b, aes(x=UMAP_1, y=UMAP_2, colour=(LTR5B))) + geom_point(size=0.5) + facet_wrap(.~condition) + theme_classic() + scale_color_gradient(low = "lightgray", high = "red") + labs(colour="Cluster expression\n(norm by num cells)") + theme(text=element_text(size=15)) + ggtitle("LTR5B")
...
ggplot(ltr17, aes(x=UMAP_1, y=UMAP_2, colour=(LTR17))) + geom_point(size=0.5) + facet_wrap(.~condition) + theme_classic() + scale_color_gradient(low = "lightgray", high = "red") + labs(colour="Cluster expression\n(norm by num cells)") + theme(text=element_text(size=15)) + ggtitle("LTR17")
```
