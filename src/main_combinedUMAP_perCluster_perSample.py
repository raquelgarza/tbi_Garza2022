...
raw_path = {"healthy":"/projects/fs5/jakobssonlab/CTG_Seq109_110/210202_A00681_0301_BHWFL5DMXX/HWFL5DMXX/outs/fastq_path/10Xsc/", "TBI" : ["/projects/fs5/jakobssonlab/CTG_Seq093_98_SingleNuclei/FastQFiles/", "/projects/fs5/jakobssonlab/Seq073_Glioma/Seq073_75/HNWHHDMXX/outs/fastq_path/10Xsc/", "/projects/fs5/jakobssonlab/CTG_Seq093_Seq104/MJ/"]}
lunarc = "config_files/lunarc_config.json"
modules = "config_files/software_modules.json"

tbi = truster.Experiment("tbi_per_sample", lunarc, modules)
...
#index_dir = "/projects/fs1/common/genome/lunarc/10Xindexes/cellranger/6.0/refdata-gex-GRCh38-2020-A/"
index_dir = "/projects/fs3/jakobssonlab/premRNAREF_SingleCells/GRCh38_premRNA/" 
#tbi.quantify(index_dir, quantification_dir, jobs=6)
...
merged_pipeline_dir = os.path.join(merged_dir, "clusterPipeline_per_sample")

print(tbi.samples.keys())

#tbi.process_clusters(mode = "merged", outdir = merged_pipeline_dir, gene_gtf = gene_gtf, te_gtf = te_gtf, star_index = star_index, RAM = 48725506423, jobs=8, tsv_to_bam = False, filter_UMIs = False, bam_to_fastq = False)

tbi.process_clusters(mode = "merged", outdir = merged_pipeline_dir, gene_gtf = gene_gtf, te_gtf = te_gtf, star_index = star_index, RAM = 48725506423, jobs=17, groups = {"TBI_HuBrainCTL_Nuclei501F_Hg38" : ["TBI_HuBrainCTL_Nuclei501F_Hg38"], "TBI_HuBrainCTL_Nuclei501T_Hg38" : ["TBI_HuBrainCTL_Nuclei501T_Hg38"], "TBI_HuBrainCTL_Nuclei502T_Hg38" : ["TBI_HuBrainCTL_Nuclei502T_Hg38"], "TBI_HuBrainCTL_Nuclei529F_Hg38" : ["TBI_HuBrainCTL_Nuclei529F_Hg38"], "TBI_HuBrainCTL_Nuclei529T_Hg38" : ["TBI_HuBrainCTL_Nuclei529T_Hg38"], "HuBrain_TBI_no6" : ["HuBrain_TBI_no6"], "HuBrain_TBI_no7" : ["HuBrain_TBI_no7"], "HuBrain_TBI_no8" : ["HuBrain_TBI_no8"], "MJ_TBI_nr1" : ["MJ_TBI_nr1"], "MJ_TBI_nr2" : ["MJ_TBI_nr2"], "MJ_TBI_nr3" : ["MJ_TBI_nr3"], "MJ_TBI_nr10" : ["MJ_TBI_nr10"], "MJ_TBI_nr11" : ["MJ_TBI_nr11"], "MJ_TBI_nr16" : ["MJ_TBI_nr16"], "MJ_TBI_nr19" : ["MJ_TBI_nr19"], "MJ_TBI_nr20" : ["MJ_TBI_nr20"], "MJ_TBI_nr21" : ["MJ_TBI_nr21"] }, tsv_to_bam = False, filter_UMIs = False, bam_to_fastq = False, concatenate_lanes = False, merge_clusters = False, map_cluster = False, TE_counts = False)
